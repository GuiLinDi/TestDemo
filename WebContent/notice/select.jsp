    ...
    <table  width="98%" border="0" align="center" cellpadding="4" cellspacing="1" class="datatable" >
      <tr>
       ...
       <input type="text" name="title1">
        ...
        <tr>
          <td  colspan="6"> 
            <input type="button" value="查询"  class="bt" onClick="doSubmit('NoticeServlet?param=selectBy')"/>
            <input type="button"  value="增加"  class="bt" onClick="doSubmit('NoticeServlet?param=AU_2in1&type=1')"/>
          </td>
      </tr>
    </table>
  </div>
       ...
       <c:forEach items="${datalist }" var="notice">
         <tr>
            ...
            <td class="listTableLine1" >${notice.sendtime }</td>
			 ...
			 <a  style="cursor:pointer;" href="<%=path %>/NoticeServlet?param=delete&id=${notice.id}&type=1 "><u>删除</u></a>
			 <a  style="cursor:pointer;" href="<%=path %>/NoticeServlet?param=AU_2in1&id=${notice.id }&type=1"><u>修改</u></a>
			 </td>
          </tr>
