...
<form action="<%=path%>/JoblogServlet" method="post">
<table height="30" cellspacing="0" cellpadding="0" width="98%" 
  ...
  <tr align="left">
    ...
    <td class="listTableLine2" width="80%">
  		<input type="text" name="times" id="times" value="${jl.times }" onclick="getdate()">
    </td>
  </tr>
  <tr align="left">
  ...
  <tr align="left">
   ...
   <tr align="left">
    <td class="listTableLine2" >&nbsp;记录时间</td>
    <td class="listTableLine2" width="80%">
  		 <input type="text" name="rectime" id="rectime" value="${jl.rectime }" onclick="gettime()">
    </td>
  </tr>
   <tr align="left">
